...
<?php echo $this->Form->create('FeedbackResponse'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Feedback Response'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FeedbackResponse.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('FeedbackResponse.id'))); ?></li>
